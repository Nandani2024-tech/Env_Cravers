...
def grade_task_2(env_state: EnvState, patient_hidden_states: dict, patient_observations: dict, final_queue: list[str]) -> tuple[float, dict]:
    """Calculates the finale episode score combining accuracy and queue prioritization (Task 2)."""
    details = get_task_2_breakdown(env_state, patient_hidden_states, patient_observations, final_queue)
